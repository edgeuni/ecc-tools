...
void PrintUsage(const char* program_name) {
  IEDALOG.info(ieda::Loc::current(), "Density Evaluation");
...
void TestDensityMapFromIDB(const string& db_config_path)
{
  ...
  IEDALOG.info(ieda::Loc::current(), "Macro density: ", density_map_summary.cell_map_summary.macro_density);
  IEDALOG.info(ieda::Loc::current(), "StdCell density: ", density_map_summary.cell_map_summary.stdcell_density);
  IEDALOG.info(ieda::Loc::current(), "AllCell density: ", density_map_summary.cell_map_summary.allcell_density);
  IEDALOG.info(ieda::Loc::current(), "Macro pin density: ", density_map_summary.pin_map_summary.macro_pin_density);
  IEDALOG.info(ieda::Loc::current(), "StdCell pin density: ", density_map_summary.pin_map_summary.stdcell_pin_density);
  IEDALOG.info(ieda::Loc::current(), "AllCell pin density: ", density_map_summary.pin_map_summary.allcell_pin_density);
  IEDALOG.info(ieda::Loc::current(), "Local net density: ", density_map_summary.net_map_summary.local_net_density);
  IEDALOG.info(ieda::Loc::current(), "Global net density: ", density_map_summary.net_map_summary.global_net_density);
  IEDALOG.info(ieda::Loc::current(), "All net density: ", density_map_summary.net_map_summary.allnet_density);

  ieval::NetMapSummary net_map = density_api.netDensityMap(stage, grid_size);
  IEDALOG.info(ieda::Loc::current(), "Local net density: ", net_map.local_net_density);
  IEDALOG.info(ieda::Loc::current(), "Global net density: ", net_map.global_net_density);
  IEDALOG.info(ieda::Loc::current(), "All net density: ", net_map.allnet_density);
}
...
void TestMarginMap()
{
  ...
  IEDALOG.info(ieda::Loc::current(), "Horizontal margin: ", macro_margin_summary.horizontal_margin);
  IEDALOG.info(ieda::Loc::current(), "Vertical margin: ", macro_margin_summary.vertical_margin);
  IEDALOG.info(ieda::Loc::current(), "Union margin: ", macro_margin_summary.union_margin);
}

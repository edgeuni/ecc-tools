...
class PGNet
{
 public:
  ...
  std::map<std::string, std::string>& get_io_pin_name_to_direction_map() { return _io_pin_name_to_direction_map; }
  std::vector<std::string>& get_instance_pin_name_list() { return _instance_pin_name_list; }

  // const getter
  const std::string& get_name() const { return _name; }
  const std::map<std::string, std::string>& get_io_pin_name_to_direction_map() const { return _io_pin_name_to_direction_map; }
  ...
  void set_io_pin_name_to_direction_map(const std::map<std::string, std::string>& io_pin_name_to_direction_map)
  {
  ...
  // function
  void add_io_pin(std::string pin_name, std::string direction) { _io_pin_name_to_direction_map[pin_name] = direction; }
  void add_instance_pin(std::string pin_name) { _instance_pin_name_list.push_back(pin_name); }

 private:
  std::string _name;
  PGNetType _type = PGNetType::kNone;
  std::map<std::string, std::string> _io_pin_name_to_direction_map;

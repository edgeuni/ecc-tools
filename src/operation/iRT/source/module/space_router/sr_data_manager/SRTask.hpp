...
class SRTask
{
 public:
  ...
  std::vector<Segment<LayerCoord>>& get_current_routing_segment_list() { return _current_routing_segment_list; }
  ...
  const std::vector<Segment<LayerCoord>>& get_current_routing_segment_list() const { return _current_routing_segment_list; }
  ...
  void set_current_routing_segment_list(const std::vector<Segment<LayerCoord>>& routing_segment_list)
  {
    _current_routing_segment_list = routing_segment_list;
  }
  void set_best_routing_segment_list(const std::vector<Segment<LayerCoord>>& routing_segment_list)
  {
    _best_routing_segment_list = routing_segment_list;
  }
 ...
 private:
  ...
  std::vector<Segment<LayerCoord>> _current_routing_segment_list;

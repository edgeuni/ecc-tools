...
class Database
{
 public:
  ...
  std::vector<MacroRouteHalo>& get_macro_route_halo_list() { return _macro_route_halo_list; }
 ...
 private:
  ...
  std::vector<MacroRouteHalo> _macro_route_halo_list;

...
class DataManager final
{
 ...
 public:
  ...
  auto commitOptimization(std::unique_ptr<Design> design, ClockLayout clock_layout, const OptimizationSummary& summary)
      -> DataManagerStatus;
  ...
  auto getEvaluationState() -> EvaluationState& { return _evaluation_state; }

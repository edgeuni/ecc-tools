...
class SWModel
{
 public:
  ...
  std::unordered_map<int32_t, int32_t>& get_design_layer_id_to_report_layer_id_map() { return _design_layer_id_to_report_layer_id_map; }
  // setter
  ...
  void set_design_layer_id_to_report_layer_id_map(const std::unordered_map<int32_t, int32_t>& design_layer_id_to_report_layer_id_map)
  {
 ...
 private:
  ...
  std::unordered_map<int32_t, int32_t> _design_layer_id_to_report_layer_id_map;
};

...
class SPEFReportLayer
{
 public:
  ...
  ~SPEFReportLayer() = default;
  // getter
  int32_t get_report_layer_id() const { return _report_layer_id; }
  int32_t get_design_layer_id() const { return _design_layer_id; }
  std::string& get_design_layer_name() { return _design_layer_name; }
  std::string& get_process_layer_name() { return _process_layer_name; }
  // setter
  void set_report_layer_id(int32_t report_layer_id) { _report_layer_id = report_layer_id; }
  void set_design_layer_id(int32_t design_layer_id) { _design_layer_id = design_layer_id; }
 ...
 private:
  int32_t _report_layer_id = INT32_MAX;
  int32_t _design_layer_id = INT32_MAX;

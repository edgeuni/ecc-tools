...
void TopologyBuilder::appendNodeIfAbsent(Net& net,
...
size_t TopologyBuilder::appendNode(std::vector<TopoNode>& node_list,
                                 std::vector<bool>& node_shape_valid_list,
                                 TopoNode node,
                                 bool is_shape_valid)
{
...
void TopologyBuilder::mergeNodeShape(std::vector<TopoNode>& node_list,
                                     std::vector<bool>& node_shape_valid_list,
                                     size_t node_idx,
...
GtlRectI TopologyBuilder::getEndpointShape(Segment& segment, const GtlPointI& point)
{

...
void ResistanceCalculator::calculateCornerResistance(size_t corner_idx)
{
...
void ResistanceCalculator::calculateNetResistance(size_t corner_idx, size_t net_idx)
{
  Database& database = RCXDM.getDatabase();
...
ProcessVia* ResistanceCalculator::getProcessVia(CornerData& corner_data, size_t design_layer_id)
{
...
ProcessConductor* ResistanceCalculator::getProcessConductor(CornerData& corner_data, size_t design_layer_id)
{
  LayerTable& layer_table = RCXDM.getDatabase().get_layer_table();
  std::unordered_map<size_t, std::string>& design_id_to_name_map = layer_table.get_design_id_to_name_map();
  if (design_id_to_name_map.count(design_layer_id) == 0) {

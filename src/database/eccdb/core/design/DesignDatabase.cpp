...
DesignDatabase::DesignDatabase(const TechRegistry& tech_registry, const LibraryRegistry& library_registry)
...
void DesignDatabase::resetForBinaryLoad()
{
...
void DesignDatabase::bindBinaryLoadedRoot()
{

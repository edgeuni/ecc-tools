...
class DefNameCache
{
 ...
 public:
  explicit DefNameCache(const DesignDatabase& design)
  {
...
std::string_view nonDefaultRuleName(const DesignDatabase& design, TechNonDefaultRuleId id)
{
...
std::string_view nonDefaultRuleName(const DesignDatabase& design, DesignNonDefaultRuleId id)
{
  return design.routingStorage().nonDefaultRule(id).name;
}

std::string_view nonDefaultRuleName(const DesignDatabase& design, const DesignNet& net)
{
...
void writeNetSection(DefTextOutput& output, const DesignDatabase& design, const DefNameCache& names,

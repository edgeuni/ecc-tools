...
{
 public:
  TechLefWriter(std::ostream& output, const TechDatabase& database, int32_t database_units_per_micron)
 ...
 private:
  ...
  std::ostream& _output;
  const TechDatabase& _database;
  int32_t _database_units_per_micron;
};

[[nodiscard]] int32_t requireDatabaseUnits(const TechDatabase& database)
{
...
void LefTechExporter::write(std::ostream& output, const TechDatabase& database)
{
...
void LefTechExporter::write(const std::filesystem::path& path, const TechDatabase& database)
{

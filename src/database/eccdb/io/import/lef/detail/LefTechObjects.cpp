#include "import/lef/detail/LefTechObjects.h"
...
TechLayerId requireLayer(const TechDatabase& database, const std::string& name, const char* field)
{
...
TechRoutingLayerId requireRoutingLayer(const TechDatabase& database, const std::string& name, const char* field)
{
...
TechCutLayerId requireCutLayer(const TechDatabase& database, const std::string& name, const char* field)
{
  const auto layer = requireLayer(database, name, field);
...
TechConductorLayerRef requireConductorLayer(const TechDatabase& database, const std::string& name, const char* field)
{
  const auto layer = requireLayer(database, name, field);
...
TechViaMasterShapeInput materializeGeneratedVia(const TechDatabase& database, const PreparedGeneratedVia& source)
{
...
TechViaMasterShapeInput fixedViaShapes(const TechDatabase& database, const PreparedViaMaster& source)
{
...
void commitViaGenerateRules(TechDatabase& database, const std::vector<PreparedViaRule>& rules)
{
...
void commitVias(TechDatabase& database, const std::vector<PreparedViaMaster>& vias)
{
...
void commitOrdinaryViaRules(TechDatabase& database, const std::vector<PreparedViaRule>& rules)
{
  for (const auto& source : rules) {
    if (source.generate) {
      continue;
...
void commitNonDefaultRules(TechDatabase& database, const std::vector<PreparedNonDefaultRule>& rules)
{

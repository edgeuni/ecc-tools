...
END LIBRARY
  ...
  const LibraryDatabaseOptions options{.geometry = GeometryPoolOptions{.polygon_mode = PolygonStorageMode::kRectangularized}};
  LibraryDatabase rectangularized_library(technology.techRegistry(), options);

...
using InstanceId = DesignInstanceId;
using InstancePinId = DesignInstancePinId;
using IoPinId = DesignIoPinId;
using NetId = DesignNetId;
using ViaId = DesignViaId;
using WireId = DesignWireId;

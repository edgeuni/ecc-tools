...
{
  if (std::getenv("IDB_REFACTOR_RUN_LARGE_DEF_MEMORY_TEST") == nullptr) {
    GTEST_SKIP() << "set IDB_REFACTOR_RUN_LARGE_DEF_MEMORY_TEST=1 to run the large DEF memory comparison";
  }

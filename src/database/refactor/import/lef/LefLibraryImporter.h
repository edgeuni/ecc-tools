...
// One-shot importer from SI2 LEF callbacks into one LibraryDatabase. Parser
...
{
 public:
  LefLibraryImporter(const TechDatabase& technology, LibraryDatabase& library) : _technology(technology), _library(library) {}

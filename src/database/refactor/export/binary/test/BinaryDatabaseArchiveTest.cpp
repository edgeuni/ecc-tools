...
std::string exportTech(const TechDatabase& technology)
{
...
std::string exportLibrary(const TechDatabase& technology, const LibraryDatabase& library)
{
  std::ostringstream output;
...
{
  TechDatabase source_technology;
  LefTechImporter(source_technology).import(domain.technology);
  LibraryDatabase source_library(source_technology.techRegistry());

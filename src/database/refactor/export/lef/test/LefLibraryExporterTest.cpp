...
#include "integration/test/LefPdkCorpus.h"
...
void expectPort(const LibraryDatabase& expected_database, const LibraryMasterPort& expected, const LibraryDatabase& actual_database,
...
void expectObs(const LibraryDatabase& expected_database, const LibraryMasterObs& expected, const LibraryDatabase& actual_database,
...
void expectLibrary(const LibraryDatabase& expected, const LibraryDatabase& actual)
{
...
void expectRoundTrip(const lef_test::LefPdkDomain& domain)
{
  ...
  LibraryDatabase source(technology.techRegistry());
  ...
  LibraryDatabase roundtripped(technology.techRegistry());
...
END LIBRARY
  ...
  LibraryDatabase source(tech.techRegistry());
  ...
  LibraryDatabase roundtripped(tech.techRegistry());

# Tech Refactor Directory

This tree is the EnTT-first technology database. `TechDatabase` owns one
...
Layer names are enforced by `TechDatabase` in one Tech-wide namespace.

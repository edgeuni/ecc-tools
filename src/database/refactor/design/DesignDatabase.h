...
{
 public:
  DesignDatabase(const TechRegistry& tech_registry, const LibraryRegistry& library_registry);
  DesignDatabase(const DesignDatabase&) = delete;
  DesignDatabase& operator=(const DesignDatabase&) = delete;
  DesignDatabase(DesignDatabase&&) = delete;
  DesignDatabase& operator=(DesignDatabase&&) = delete;

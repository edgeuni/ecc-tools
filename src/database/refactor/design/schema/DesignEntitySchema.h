...
#ifndef IDB_REFACTOR_DESIGN_ENTITY_BITS
#define IDB_REFACTOR_DESIGN_ENTITY_BITS 64
#endif

#if IDB_REFACTOR_DESIGN_ENTITY_BITS == 32
using ActiveDesignEntitySchema = DesignEntitySchema32;
#elif IDB_REFACTOR_DESIGN_ENTITY_BITS == 64
using ActiveDesignEntitySchema = DesignEntitySchema64;
#else
#error "IDB_REFACTOR_DESIGN_ENTITY_BITS must be 32 or 64"
#endif

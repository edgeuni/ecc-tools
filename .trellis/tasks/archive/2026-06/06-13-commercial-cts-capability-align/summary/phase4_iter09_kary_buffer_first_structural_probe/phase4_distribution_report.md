...
- H-tree depth pruning has a first monotone hard fail in 0 / 23 cases.
- The first hard fail exceeds the current single-stage local split capacity (`max_fanout^2`) in 0 / 23 cases.
- Sink clustering is packed to the minimum legal cluster count in 20 / 23 cases.
- Source-to-root segment inserts at least one buffer in 0 / 23 cases.
...
| HTree selected depth minus Innovus max depth | level | 23 | -1.95652 | -2 | -4 | -1 | 2.09554 |
...
| cluster leaf mean distance | um | 23 | 8.87 | 8.51 | 6.43 | 18.28 | 9.1786 |
| hard fail load count | loads | 0 |  |  |  |  |  |
| hard fail over max_fanout^2 | loads | 0 |  |  |  |  |  |
...
| --- | --- | --- | --- |
| latency delta vs selected HTree depth delta | 23 | 0.132582 | 0.0175779 |
| latency delta vs trunk wire ratio | 23 | -0.00705711 | 4.98028e-05 |
| latency delta vs cluster leaf mean distance | 23 | 0.120855 | 0.014606 |
| skew delta vs timing stage spread delta | 23 | 0.680077 | 0.462505 |
| skew delta vs cluster leaf max distance | 23 | 0.496991 | 0.247 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| iwls2005__vga_lcd | 0.181 | 0.051 | 3 | -3 |  |  | 3.99929 | 8.51 | 1.60159 |
| openroad__dynamic_node | 0.132 | 0.018 | 2 | -1 |  |  | 4 | 8.05 | 1.54524 |
| iwls2005__usb_funct | 0.083 | 0.038 | 1 | -2 |  |  | 3.96429 | 18.28 | 1.47631 |
| iwls2005__spi | 0.093 | 0.023 | 2 | -1 |  |  | 3.94828 | 9.01 | 1.83484 |
| iwls2005__des | 0.082 | 0.032 | 2 | -2 |  |  | 4 | 8.42 | 1.54463 |
| openroad__fifo | 0.0715 | -0.021 | 1 | -2 |  |  | 4 | 8.55 | 1.76471 |
| iwls2005__mem_ctrl | 0.076 | 0.01 | 2 | -2 |  |  | 3.99145 | 9.5 | 1.6277 |
| openroad__uart | 0.0635 | -0.015 | 1 | -2 |  |  | 3.95 | 7.44 | 1.86345 |
| openroad__gcd | 0.0515 | 0.026 | 2 | -1 |  |  | 3.77778 | 9.3 | 1.64823 |
| iwls2005__systemcaes | 0.0645 | 0.01 | 1 | -2 |  |  | 3.9881 | 9.67 | 1.54457 |
